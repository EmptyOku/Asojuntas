...
return [
    ...
    */
    ...
    'uploaded' => 'No fue posible subir el archivo del campo :attribute.',
    ...
    */
    ...
    | text with something more reader friendly, such as "E-Mail Address"
    | instead of "email". This simply helps us make the message more
    | expressive.
    |
    */
    ...
    'attributes' => [
        ...
        'slate_id' => 'plancha',
        'slate_code' => 'código de plancha',
        'polling_table_id' => 'mesa de votación',
        'record_number' => 'número de acta',
        'record_date' => 'fecha del acta',
        'record_time' => 'hora del acta',
        'votes' => 'votos',
