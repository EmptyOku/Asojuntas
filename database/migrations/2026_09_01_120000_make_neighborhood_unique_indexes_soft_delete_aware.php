...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('neighborhoods', function (Blueprint $table): void {
            foreach ($this->indexes as $index) {$table->unique(['commune_id', $index['column']],$index['partial']);
            }
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('neighborhoods', function (Blueprint $table): void {
            foreach ($this->indexes as $index) {$table->unique(['commune_id', $index['column']],$index['legacy']);
            }
        });
    }
    ...
    private function dropIndexIfExists(string $name): void
    {
        ...
        if ($driver === 'pgsql') {
            ...
            // DROP INDEX posterior cubre el caso del índice parcial ya creado.
